...
export default function Timeline() {
    ...
    return (
        <section id="experience" className="py-24 relative bg-neutral-50 dark:bg-neutral-950">
                    ...
                    <div className="relative">
                        ...
                        {experience.map((exp, index) => (
                            ...
                            >
                                ...
                                <div className="hidden md:flex w-10 h-10 rounded-full items-center justify-center ml-4 mr-4 z-10 bg-sky-600 dark:bg-sky-500">
